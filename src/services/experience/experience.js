...
experiencesRouter
  ...
  .post(async (req, res, next) => {
    ...
    .get(async (req, res, next) => {
        // try {
        //     const getExperiences = await ExperienceModel.find(req.params.userId)
...
// const userFound = await UserModel.find(b => b._id.toString() === req.params.userId)
...
//     const newPost = { ...req.body, username: userFound.username }

//     const postExperence = await ExperienceModel.findOne({
//         $push: { newPost }
//     })
//     res.send(newPost)
...
// const updatedExperience = await UserModel.find(
//     req.params.user,
//     {
//         $push: {
//             experiences: newExperience,
...
//     res
//         .status(404)
//         .send(`profile with userid: ${req.params.id} not found`);
// }
//     } catch (error) {
//         next(createError(500, "Error in posting experience details"));
//     }
